...
const styles = StyleSheet.create({
  ...
  errorText: { ...typography.bodyM, color: colors.danger, marginTop: spacing.sm },
  ...
  swatch: { width: 12, height: 12, borderRadius: 2, marginRight: spacing.xs },
  listLabel: { flex: 1, ...typography.bodyM, color: colors.textPrimary },
  listConf: { width: 48, textAlign: 'right', ...typography.bodyM, color: colors.textMuted },
  listBbox: {
    width: 140,
    textAlign: 'right',
    fontSize: 11,
